...
const historyHandler: historyHandler={
    ...
    toggleHistory(historyFlag){
        const elements = {
            historyContainer: document.querySelector('.calculator__history') as HTMLDivElement,
            display: document.querySelector('.calculator__display') as HTMLDivElement,
            keypad: document.querySelector('.calculator__keypad') as HTMLDivElement,
            historyHeading: document.querySelector('.history__heading') as HTMLHeadingElement,
            calculator: document.querySelector('.calculator') as HTMLDivElement,
            deleteHistorybtn: document.querySelector('.btn--clearHistory') as HTMLButtonElement,
        };
