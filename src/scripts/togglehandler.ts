...
interface toggleHandler{
    toggleSign: (this: Calculator)=>void,
    convertToreciprocal: (this: Calculator)=>void,
    powerOften: (this: Calculator)=>void,
    convertFixedToExponent: (this: Calculator)=>void,
    toggleSecondfunctionality: (this: Calculator,element: HTMLButtonElement)=>void,
}

const toggleHandler: toggleHandler={
    ...
    toggleSecondfunctionality(element){
        const button1=document.getElementsByClassName('secondfunc--btn1')[0] as HTMLButtonElement;
        const button2=document.getElementsByClassName('secondfunc--btn2')[0] as HTMLButtonElement;
...
export function toggleTrignobutton(this: Calculator): void{
    const element=document.getElementsByClassName('dropdown--trigno')[0] as HTMLDivElement;
    if(this.trignoFlag){
...
export function toggleFunctionbutton(this: Calculator): void{
    const element=document.getElementsByClassName('dropdown--function')[0] as HTMLDivElement;
...
export function closeTogglebuttons(this: Calculator): void{
    this.trignoFlag=false;
    this.functionFlag=false;
    toggleTrignobutton.call(this);
    toggleFunctionbutton.call(this);
